...
function appliquerModifications() {
  const modifications = {
    ...
    "cours-1-slide-13": { text: "a", href: "a" },
    "cours-1-slide-14": { text: "a", href: "a" },
    "cours-1-slide-15": { text: "a", href: "a" },
    "cours-1-slide-16": { text: "a", href: "a" },
