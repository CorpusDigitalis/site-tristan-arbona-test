  ...
  for (const id in modifications) {
    ...
    if (props.href !== undefined) {
      if (element.tagName.toLowerCase() === "a") {
        ...
        // Si l'élément n'est pas un lien, on cherche un lien enfant pour modifier href
        const linkChild = element.querySelector("a");
        if (linkChild) linkChild.href = props.href;
      }
    }
  }
}
...
function tryApplyModifications() {
  if (headerLoaded && footerLoaded && domLoaded) {
